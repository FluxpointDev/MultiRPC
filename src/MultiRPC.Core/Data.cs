...
namespace MultiRPC.Core
{
    ...
    public static class Data
    {
        static Data()
        {
            ...
            MultiRPCImages = MakeImagesDictionary();
        }
        ...
        {
            {GetLineFromLanguageFile("NoImage"), null},
            ...
            {GetLineFromLanguageFile("Christmas"), new Uri("https://i.imgur.com/NF2enEO.png") },
            {GetLineFromLanguageFile("Present"), new Uri("https://i.imgur.com/qMfJKt6.png") },
            {"Neko", new Uri("https://i.imgur.com/l2RsYY7.png") },
            {GetLineFromLanguageFile("Popcorn"), new Uri("https://i.imgur.com/xplfztu.png") },
            {"Skype", new Uri("https://i.imgur.com/PjQFB6d.png") },
            {GetLineFromLanguageFile("Games"), new Uri("https://i.imgur.com/lPrT5BG.png") },
